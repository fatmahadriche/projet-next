...
useEffect(() => {setReference(article.reference)
    ...
    return {load: (source, load, error, progress, abort, headers) => {
...
</div><Button type="submit" className="btn btn-pink">Valider</Button>
</Form>
</div>
)
}
